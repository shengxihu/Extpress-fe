...
const CurrentTags = (props) => {
  return <div className="current_tags">{ props.children }</div>
}
...
class CommentBox extends React.Component {
  ...
  _onAddDataHandler(val) {
    ...
    this.setState({
      tags: this.state.tags.concat(val)
    });
  }
  ...
  render() {
    ...
    return <div className="container">
					<form action="" id="comment_form" className="comment_form">
						<div className="main">
							<textarea placeholder="请从教学质量、课程内容、给分、考勤、期末考察方式等方面评价，欢迎长篇/优质的评论" name="body" id="body" className="textarea"></textarea>
